          ...
          <Carousel controls={false} indicators={false}>
            <Carousel.Item>
              <div>
                ...
                <h1>Аренда с доставкой и трансфером</h1>
                </Carousel.Caption>
              </div>
            </Carousel.Item>
          </Carousel>
    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        ...
        <h3 style={{textAlign: 'center'}}>🌊 Погрузись мир водных приключение с нами! 🚣‍♂️</h3>
            ...
            <p style={{fontSize: '18px', textAlign: "justify"}}>🎉 Открой новые горизонты вместе с нами! <a href="tel:+79521233539">Забронируй</a> байдарки уже сегодня и отправляйся на водные приключения, создавая незабываемые воспоминания. 📞
            </p>
        </div>
      </Col>
    </Row>
