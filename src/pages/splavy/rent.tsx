      ...
      <div className="container text">
        ...
        <div className={row}>
          <div>
            ...
            <p style={{ fontSize: '18px', textAlign: "justify" }}>Как показала практика, не все, кто берут в аренду, понимают как правильно организовать поход, и сколько усилий на это нужно потратить. Цена ошибки слишком высока т.к. на кону отпуск и впечатления всей компании.</p>
