...
const TwoDays = () => (
    <div className={feature}>
        ...
        <div className={rowText} style={{ maxWidth: 800 }}>Сплав по реке Кердь с впаданием в Проню и финишем в древнем городе Пронске. Ночевка в оборудованном глемпинге на реке Проня с душем, электричеством, санузлом и различными вариантами размещения. На природу со всеми благами цивилизации! Отдых в режиме всё включено: Питание, трансфер, инструкторы и много другое. <br /> <br /> <b style={{ color: '#3D3D3D' }}>Цена</b>: {routesConfig.twoDays.price}</div>
