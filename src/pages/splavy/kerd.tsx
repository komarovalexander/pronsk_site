          ...
          <div className={rowText}>
            ...
            <i>
              * утренние однодневные сплавы организуем по будням и в субботу
              <br />
              <br />
              * по воскресеньям мы организуем однодневные сплавы под закат. Программа та же, только встречается в 16:00 и приплываем на финиш, любуясь закатами отражающимися в волнах широкой Прони
            </i>
          </div>
        </div>
      </div>
        ...
        <div className={row}>
          <div>
            ...
            <p style={{ fontSize: '18px', textAlign: "justify" }}>
              <b style={{ fontSize: '14px' }}>обед</b> <span style={{ fontSize: '14px' }}>(или ужин в случае сплава под закат)</span>: {foodConfig.lunch}
              <br />
