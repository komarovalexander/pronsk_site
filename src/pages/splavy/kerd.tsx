    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        <div className="container text">
          ...
          напоминающей горную, каменистую, с поворотами и мини порогами, удивительными видами и витвистыми деревьями по берегам, постепенно все меняется 
          и вот мы на финише уже на огромной широкой реке - Проне.
          ...
          Данный маршрут (протяжённостью ≈ 18 км)  подходит всем желающим.</p>
          <i style={{fontSize: '18px', textAlign: "justify"}}>Стоимость 1-дневного сплава 2000 р. с человека, для детей до 14 лет скидка 1000р. Входит:<br />
    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        <div className="container text">
          ...
          16:00 - финиширование у Пронского моста, обратный трансфер к дому<br />
