...
const prony = () => (
  <Layout>
    ...
    <div className="container text">
      ...
      <i style={{fontSize: '18px', textAlign: "justify"}}>* Бронирование производится по 30% предоплате, предварительно можете ознакомиться с графиком занятости путешествий.
    ...
    <div className="container text" style={{paddingTop: 30}}>
      ...
      12:00 – прибытие в г.Пронск к нашему дому, трансфер на место старта.<br />
      ...
      19:00 – встречаем вас с готовым лагерем, игры на берегу, ужин, походная баня, душевные посиделки у костра
      </p>
