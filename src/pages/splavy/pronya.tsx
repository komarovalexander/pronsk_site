    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        <div className="container text">
          ...
          Благодаря сотрудничеству с перкрасным <a href='https://pronyaglamping.ru/'>Глемпинг-парком БЕРЕГ</a> вам будет доступна вся инфраструктура глемпинга (туалет, душ, интернет, пляж и т.д.)</p>
          ...
          В этом месте вы точно почувствуете уединение с природой и отдохнете от городского ритма и суеты. Данный маршрут (протяжённостью ≈ 31 км) подходит всем желающим</p>
