      ...
      <div className={`${row} ${rowReversed}`}>
        ...
        <div className={rowText}>
          ...
          <p style={{ fontSize: '18px', textAlign: 'justify' }}>
            10:00 – встреча в Глемпинге "Берег" р.п. Пронск, трансфер на место старта.
            <br />
            10:30 - инструктаж
            <br />
            11:00 - сплав на байдарках
            <br />
            13:00 - обед на стоянке, отдых
            <br />
            14:00 - сплав на байдарках
            <br />
            16:00 – прибытие в Глемпинг "Берег", свободное время
            <br />
            19:00 - ужин
            <br />
      ...
      <div className={container}>
        ...
        <div className={row}>
          <div>
            ...
            <p>
              Если вы едите издалека - то вы можете приехать за день до сплава, переночевать в удобном для вас варианте размещения, и с утра
        ...
        >
          <div className={feature}>
            ...
            <div
              ...
              style={{ maxWidth: 800 }}
            >
              Уютный красивый домик на природе на территории глэмпинга с двухспальной кроватью, диваном, личным туалетом, душем,
              микроволновкой, чайником и холодильником. Для 2х человек, дополнительно можно подселить 1 взрослого или 2х детей
            </div>
          </div>
          <div className={feature}>
            <iframe
