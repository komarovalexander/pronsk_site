      ...
      <div className={container}>
        ...
        <div className={row} style={{ alignItems: 'start' }}>
          <div className={feature}>
            ...
            <h4 className={featureHeader}>Палатко-место в глемпинге - 2000₽ за палатку</h4>
            <div className={rowText} style={{ maxWidth: 800 }}>Вся инфраструктура глемпинга - электричество, душ, туалет доступна тем кто проживает в палатках. Нужно только оплатить место под палатку. <br />Можно приехать со своей палаткой, но также оборудование для комфортного сна на природе до 4х человек на одно палатко-место наша команда предоставляет бесплатно (палатку на 3-4 человека, мягкие коврики в палатку, спальники)</div>
          </div>
          <div className={feature}>
