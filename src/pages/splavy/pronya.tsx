...
const pronya = () => (
  <Layout>
    ...
    <div className={container} style={{
      ...
      <div className={`${row} ${rowReversed}`}>
        ...
        <div className={rowText}>
          ...
          <p style={{ fontSize: '18px', textAlign: "justify" }}>
            10:00 – встреча в Глемпинге "Берег" р.п. Пронск, трансфер на место старта.<br />
            10:30 - инструктаж<br />
            11:00 - сплав на байдарках<br />
            13:00 - обед на стоянке, отдых<br />
            14:00 - сплав на байдарках<br />
            16:00 – прибытие в Глемпинг "Берег", свободное время<br />
            19:00 - ужин<br />
            19:40 - поход на гору "Гневна" под закат<br />
            21:00 - душевные посиделки у костра с музыкантом<br />
          </p>
        </div>
      </div>
      <br />
      ...
      <div className={`${row}`}>
        ...
        <div className={rowText}>
          ...
          <p style={{ fontSize: '18px', textAlign: "justify" }}>
            08:30 – подъем, завтрак<br />
            10:00 - сплав на байдарках<br />
            11:00 - стоянка, посещение конной фермы "Юлианна", контактный зоопарк, дегустация молока<br />
            12:00 - сплав на байдарках<br />
            13:30 - обед на финише, конец путешествия<br />
          </p>
        </div>
      </div>
    </div>
    ...
    <div className={grayBack}>
      <div className={container}>
        ...
        <div className={row}>
          <div>
            ...
            <p style={{ fontSize: '18px', textAlign: "justify" }}>Палатки, мягкие коврики в палатку, спальники, подготовленное для отдыха и ночлега место. На выбор у нас есть также <a href="#nightPrice">другие варианты ночевки</a></p>
      ...
      <div className={container}>
        <h3 id="nightPrice" className={`${rowHeader} headerFont`}>Варианты ночёвки</h3>
        <div className={row}><p>В зависимости от пожеланий к условиям ночёвки, можно выбрать различные варианты размещения:</p></div>
