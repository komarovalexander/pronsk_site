    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        <div className="container text">
          ...
          Благодаря сотрудничеству с перкрасным <a href='https://pronyaglamping.ru/'>Глемпинг-парком БЕРЕГ</a> вам будет доступна вся инфраструктура глемпинга (туалет, душ, интернет, пляж и т.д.)
          Все передвижения проходят на байдарках, не отягощенных грузом, так как все нужные вещи для лагеря мы оставляем в глемпинге.
          Это значительно сэкономит и время, и силы участников. На лёгких байдарках передвигаться значительно веселее и комфортнее.
          Приготовление еды мы также берем на себя и предоставляем горячее питание. В наших палатках очень уютно и мягко спать за счет мягких матрасов.
          Мы попытались создать все условия, чтобы вы могли наслаждаться в полной мере сплавом и природой.</p>
          
          <p style={{fontSize: '18px', textAlign: "justify"}}>Реки пронского района удивиляют своим разнообразием путешествие начинается с Керди - небольшой речки с приятным течением, 
          напоминающей горную, каменистую, с поворотами и мини порогами, удивительными видами и витвистыми деревьями по берегам. Во время сплава вас будет окружать пение птиц, 
          шелест листьев, журчание ручья, приятная прохлада от реки и тень от деревьев.
          Вокруг много живности, рядом летают стрекозы (занесены в красную книгу), плавают утки, пасутся коровки и барашки. Постепенно все меняется 
          и вот на 2 день мы плывем на огромной широкой реке - Проне. Луга, поля, холмы, перелески – вот, что находится по разные стороны от берегов Прони.
          Если стоять на одном берегу, то открывается необъятный обзор на долины и равнины, можно долго смотреть на красивые пейзажи. 
          Если любите рыбалку, в Проне водятся разнообразные рыбы, мидии и раки, т.к. условия для размножения и обитания в ней подходящие. Они оптимальны для всех типов, даже хищных.
          Отдых на реке заряжает энергией и дарит массу приятных ощущений.
          В этом месте вы точно почувствуете уединение с природой и отдохнете от городского ритма и суеты. Данный маршрут (протяжённостью ≈ 27 км) подходит всем желающим</p>
          <i style={{fontSize: '18px', textAlign: "justify"}}>Стоимость 2-дневного сплава 5500/6000р. (будни/выходной) с человека, детям до 14 лет скидка 2000р. Входит:<br />
    ...
    <Row style={{padding: '40px 0'}}>
      <Col>
        <div className="container text" style={{paddingTop: 30}}>
          ...
          17:00 – прибытие в глемпинг, прогулка по городу, фотосессия с Покровского бугра<br /> 
          19:00 - приготовление шашлыков, душевные посиделки у костра
          </p>
          <i style={{fontSize: '18px', textAlign: "justify"}}>День 2</i>
          <p style={{fontSize: '18px', textAlign: "justify"}}>
          09:00 – подъем, завтрак<br />
          09:30 - прогулка до <a href="https://yandex.ru/images/search?from=tabbar&text=%D0%BF%D0%BE%D0%BA%D1%80%D0%BE%D0%B2%D1%81%D0%BA%D0%B8%D0%B9%20%D0%B1%D1%83%D0%B3%D0%BE%D1%80%20%D0%BF%D1%80%D0%BE%D0%BD%D1%81%D0%BA">Покровского бугра</a><br />
          11:00 - сплав на байдарках с остановками для фотографирования и купания<br />
          12:30 - посещение местных пещер<br />
          15:00 - финиширование в селе Погореловка, обратный трансфер к дому<br />
