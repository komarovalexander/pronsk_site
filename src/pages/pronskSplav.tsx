...
const pronskSplav = () => (
  <Layout>
    ...
    <div className="container text" style={{backgroundColor: '#eef0f2'}}>
      ...
      Ощутите свободу, расслабьтесь, ничто так не умиротворяет, как спокойный сплав по нашим рекам и посиделки у костра с прекрасным видом на звезды, вторая половинка точно оценит. 
    ...
    <div className="container text" style={{paddingTop: 15, paddingBottom: 50}}>
    ...
    <div className="container text" style={{backgroundColor: '#eef0f2'}}>
      ...
      <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A75e7eabb90580be319e44ef322833bfcb945a22e46adada79e14411686465898&amp;source=constructor" width="100%" height="494"></iframe>
    </div>
    ...
    <div className="container text" style={{paddingBottom: 30, backgroundColor: '#eef0f2'}}>
