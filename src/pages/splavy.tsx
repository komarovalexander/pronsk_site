...
const splavy = () => (
  <Layout>
    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        <div className="container text">
          <h3 style={{textAlign: 'center'}}>Любите путешествовать и хотите провести отлично выходные или свой отпуск?</h3>
          <p style={{fontSize: '18px', textAlign: "justify"}}>Тогда наши сплавы на байдарках то, что Вам нужно! Это прекрасная возможность отдохнуть от городской суеты, 
          обзавестись новыми знакомствами и провести время с близкими людьми наедине с природой, а всё необходимое для этого мы предоставим. <b>Сплавы каждый день, опыт не обязателен. </b> 
          ...
          и выдаем спасательные жилеты, группу сопровождает опытный инструктор. Если хотите укрепить взаимоотношения с семьей, 
            ...
            <div className="col">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">Цена 2000/3000р. (будни/выходной) с человека, детям до 14 лет скидка 1000р.</p>
