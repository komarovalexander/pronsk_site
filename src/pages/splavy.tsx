    ...
    <Row style={{backgroundColor: '#eef0f2', padding: '40px 0'}}>
      <Col>
        <div className="container text">
          ...
          <p style={{fontSize: '18px', textAlign: "justify"}}>Путешествия по рекам Рязанской области. Считаете, что водные походы под силу только профессионалам активного туризма? Мы покажем, что это совсем не так.
          Сплав по спокойным и живописным водоёмам Пронского района идеально подходят тем, кто впервые берёт в руки весла и тем кто уже не первый раз ходит по воде.</p>
          ...
          Предлагаем путешествия (как групповой, так и своей компанией - только ваш коллектив) на байдарках, как однодневные (без ночевки), так и многодневные, по живописным рекам Рязанской области.
          ...
          <p style={{fontSize: '18px', textAlign: "justify"}}>Окунитесь в приключение со своей семьей и близкими людьми и перезагрузитесь после трудовых будней, побыв наедине с природой.
