...
export const routesConfig: {
    ...
    oneDay: {
        ...
        price: <>4000₽ (сплавляемся в будни и выходные), <br /> детям до 14 лет 3000₽</>,
    ...
    twoDays: {
        ...
        price: <>7000₽ (сплавляемся в будни и выходные), <span style={{ whiteSpace: 'nowrap' }}>детям до 14 лет 5000₽.</span> Отдельно оплачивается <a href="/splavy/pronya/#nightPrice" style={{ color: 'inherit' }}>проживание в глэмпинге</a></>,
