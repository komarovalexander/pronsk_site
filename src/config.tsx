...
export const foodConfig = {
    ...
    lunch: 'рагу овощное с мясом, хлеб местный, овощи, чай с печеньем.',
...
export const routesConfig: {
    ...
    oneDay: {
        ...
        price: <>
            Стоимость 1-дневного сплава в будни:<br />
            взрослый - 5000₽, детский до 14 лет - 3500₽<br /><br />
            Стоимость 1-дневного сплава в субботу:<br />
            взрослый - 6000₽, детский до 14 лет - 5000₽<br /><br />
            Стоимость 1-дневного сплава в воскресенье, с финишем под закат:<br />
            взрослый - 4500₽, детский до 14 лет - 3000₽<br /><br />
    ...
    twoDays: {
        ...
        взрослый - 9500₽, детский до 14 лет - 6500₽<br />
        <div style={{fontSize: 12}}>* Для детей до 8 лет дополнительные скидки</div></>,
