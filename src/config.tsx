...
export const routesConfig: {
    ...
    twoDays: {
        ...
        description: <>Сплав по реке Кердь с впаданием в Проню и финишем в древнем городе Пронске. <br />Отдых в режиме всё включено: Питание, трансфер, инструкторы, палатки и много другое. Ночевка в глемпинге "Берег" на речке Проня.</>
    },
    threeDays: {
        title: 'Проня (3 Дня)',
