...
export const routesConfig: {
    ...
    twoDays: {
        ...
        price: <>8000₽ (сплавы в будни и выходные), <span style={{ whiteSpace: 'nowrap' }}>детям до 14 лет 6000₽.</span></>,
        description: <>Сплав по реке Кердь с впаданием в Проню и финишем в древнем городе Пронске. Ночевка в глемпинге на природе, со всеми удобствами цивилизации. Горячее питание на протяжении всего путешествия включено в стоимость.</>
    },
    threeDays: {
        title: 'Проня (3 Дня)',
