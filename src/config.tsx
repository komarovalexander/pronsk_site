...
export const routesConfig: {
    ...
    twoDays: {
        ...
        description: <>Сплав по реке Кердь с впаданием в Проню и финишем в древнем городе Пронске. <br />В сплав включено: Питание, трансфер, инструкторы, палатки и много другое. Отдельно оплачивается <a href="/splavy/pronya/#nightPrice" style={{ color: 'inherit' }}>ночевка в глэмпинге "Берег"</a> на речке Проня.</>
    },
    threeDays: {
        title: 'Проня (3 Дня)',
